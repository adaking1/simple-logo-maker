...
describe("Text", () => {
    ...
    // these three test for the parameter "y". This controls where the texts appears on the y axis in the viewport
    // for a triangle this value should be "140" so the text sits slightly lower that in the circle and square whose value for this should be "115"
    describe("Y", () => {
